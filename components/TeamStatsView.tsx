...
export default function TeamStatsView({ yearMonth, teams }: Props) {
  ...
  async function load() {
    ...
    const [{ data: reps }, { data: records }, { data: schedules }] = await Promise.all([
  ...
  const repStats: RepStat[] = filteredRaw.map(raw => {
    ...
    return { rep: raw.rep, visits, netMeetings, ownerMeetings, negotiations, acquisitions, actualWorkingDays, productivity, rank: 0 }
  })
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="overflow-x-auto">
          <table className="sheet-table min-w-[560px] w-full">
            <thead>
              <tr>
